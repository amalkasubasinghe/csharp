...
====================
database - execute tobeadded.sql to create database csharp-db.dbo and tbl_book table.
...
Kwown Issues.
=============
PowerShell client is not allowed to add books with empty strings for name,author and description

Need to validate inputs to sql queries.
